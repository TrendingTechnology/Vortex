...
object RiverAndroidData {
    ...
    const val ViewModel: String = "androidx.lifecycle:lifecycle-viewmodel:2.0.0"
    const val RxAndroid = "io.reactivex.rxjava2:rxandroid:2.1.1"

    const val RoomCommon = "androidx.room:room-common:2.0.0-rc01"
    const val RoomCompiler = "androidx.room:room-compiler:2.0.0-rc01"
    const val RoomRxJava2 = "androidx.room:room-rxjava2:2.0.0-rc01"
